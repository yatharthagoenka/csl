...
class Parser:
    ...
    def statements(self):
        ...
        statement = res.register(self.exp())
        ...
        while True:
            ...
            statement = res.try_register(self.exp())
            if not statement:
    ...
    def func_def(self):
        ...
        if self.cur_tok.type == TT_ARROW:
            ...
            return res.success(FuncDefNode(var_name_tok,arg_name_tok,node_to_return,False))
